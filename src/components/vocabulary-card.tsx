...
export function VocabularyCard({ word }: VocabularyCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-4 hover:shadow-md transition-all group dark:glass-card dark:border-white/15 dark:hover:border-white/25 dark:hover:shadow-lg dark:hover:shadow-accent-pink/5">
      {/* Header: Word + Badge */}
      ...
      {/* Phonetic + Audio */}
      <div className="flex items-center gap-1 text-sm text-gray-500 dark:text-white/60 mb-2">
      ...
      {isEditing ? (
        ...
        <>
          {/* English definition */}
          <p className="text-gray-600 dark:text-white/80 text-sm line-clamp-2">{word.definition}</p>
